    ...
    public class UniFiApiService : IUniFiApiService
    {
        ...
        private readonly JsonSerializerOptions _jsonSerializerOptions = new JsonSerializerOptions
        {
            ...
            Converters =
            {
                ...
                new ReportedStateConverter(),
                new RoleAttributesConverter(),
                new ConsoleGroupMemberConverter(),
                new ApplicationRoleAttributesConverter(),
                new ApplicationRoleAttributeDetailsConverter(),
                new UserDataFeaturesConverter(),
                new UserDataFeatureFloorPlanConverter(),
                new UserDataFeatureWebrtcConverter(),
                new UserDataPermissionsConverter(),
                new AppConverter(),
                new ReportedStateFeaturesConverter(),
                new ReportedStateFeaturesCloudConverter(),
                new ReportedStateFeaturesDeviceListConverter(),
                new ReportedStateFeaturesInfoApisConverter(),
                new ReportedStateFirmwareUpdateConverter(),
                new ReportedStateHardwareConverter(),
                new LocationConverter(),
                new ControllerConverter(),
                new UnAdoptedDevicesAddressConverter(),
                new UnAdoptedDeviceConverter(),
                new ControllerFeaturesConverter(),
                new ControllerAppConverter(),
                new InternetIssuesConverter(),
                new SiteInternetIssuesPeriodConverter(),
                new HostInternetIssuesPeriodConverter(),
                new ReportedStateUiConverter(),
                new SiteStatisticsConverter(),
                new SiteStatisticsCountsConverter(),
                new SiteMetaConverter(),
                new SiteStatisticsIspInfoConverter(),
                new SiteStatisticsPercentagesConverter(),
            }
        };
