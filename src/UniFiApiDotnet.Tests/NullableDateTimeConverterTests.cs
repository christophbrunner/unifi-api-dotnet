...
namespace UniFiApiDotnet.Tests
{
    ...
    {
        private readonly NullableDateTimeConverter _converter = new NullableDateTimeConverter();
        ...
        {
            // Arrange
            long unixTime = 1694591730; // Equivalent to 2023-09-13T10:15:30Z
            ...
            // Assert
            Assert.NotNull(result);
            Assert.Equal(DateTimeOffset.FromUnixTimeSeconds(unixTime).ToLocalTime().DateTime, result.Value);
        }
